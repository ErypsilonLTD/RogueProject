...
#Region "Basic Goblin List"
        ...
        Dim GoblinLobber As New EnemyData With {
                 .HealthRange = {6, 7},
                 .Armour = 0, .Defeated = Load(temp),
                 .XPYield = 1.25, .CoinYield = 3,
                 .EnemyType = "Lobber",
                 .WeaponType = "9mm Handful", .DamageRange = {2, 3}, .HitChance = {2, 8}, .CritAddative = 15,
                 .FunFact = "Has Never Seen Nor Heard Of A Gun Before"
        }
        AddNewEnemy(GoblinLobber, BasicGoblinList.EnemiesList)
...
#End Region
    ...
    Private Shared Function Load(ByVal List As String()) As Int16
    ...
    Private Shared Sub ShowEnemies(ByVal List As RegionEnemyListData)
        ...
        Do
            ...
            Dim Response As String = TakeInputs("Str", True)
